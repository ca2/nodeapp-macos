...
namespace mac
{
   ...
   string file_system::time_square(::ca2::application * papp, const char * pszPrefix, const char * pszSuffix)
   {
      string str;
   ...
   string file_system::time_log(::ca2::application * papp, const char * pszId)
   {
      return time(papp, System.dir().time_log(pszId), 9);
   }
   
   string file_system::time(::ca2::application * papp, const char * psz, int32_t iMaxLevel, const char * pszPrefix, const char * pszSuffix)
   {
   ...
   string file_system::as_string(var varFile, ::ca2::application * papp)
   {
      var varQuery;
      return as_string(varFile, varQuery, papp);
   }
   
   string file_system::as_string(var varFile, var & varQuery, ::ca2::application * papp)
   {
   ...
   void file_system::as_memory(var varFile, primitive::memory_base & mem, ::ca2::application * papp)
   {
   ...
   void file_system::lines(stringa & stra, var varFile, ::ca2::application * papp)
   {
   ...
   bool file_system::put_contents(var varFile, const void * pvoidContents, count count, ::ca2::application * papp)
   {
   ...
   bool file_system::put_contents(var varFile, const char * lpcszContents, ::ca2::application * papp)
   {
   ...
   bool file_system::put_contents(var varFile, ::ca2::file & file, ::ca2::application * papp)
   {
      ::ca2::filesp spfile;
      spfile = App(papp).file().get_file(varFile, ::ca2::file::type_binary | ::ca2::file::mode_write | ::ca2::file::mode_create | ::ca2::file::shareDenyNone | ::ca2::file::defer_create_directory);
      if(spfile.is_null())
   ...
   bool file_system::put_contents(var varFile, primitive::memory & mem, ::ca2::application * papp)
   {
      return put_contents(varFile, mem.get_data(), (count) mem.get_size(), papp);
   }
   
   bool file_system::put_contents_utf8(var varFile, const char * lpcszContents, ::ca2::application * papp)
   {
      ::ca2::filesp spfile;
      spfile = App(papp).file().get_file(varFile, ::ca2::file::type_binary | ::ca2::file::mode_write | ::ca2::file::mode_create | ::ca2::file::shareDenyNone | ::ca2::file::defer_create_directory);
      if(spfile.is_null())
   ...
   void file_system::copy(const char * pszNew, const char * psz, bool bFailIfExists, e_extract eextract, ::ca2::application * papp)
   {
      if(bFailIfExists)
      {
   ...
   string file_system::copy(const char * psz, ::ca2::application * papp)
   {
      string strCopy("copy");
      string strNew;
   ...
   bool file_system::exists(const char * pszPath, ::ca2::application * papp)
   {
   ...
   bool file_system::exists(const string & strPath, ::ca2::application * papp)
   {
   ...
   string file_system::paste(const char * pszLocation, const char * path, ::ca2::application * papp)
   {
   ...
   void file_system::trash_that_is_not_trash(stringa & stra, ::ca2::application * papp)
   {
   ...
   void file_system::trash_that_is_not_trash(const char * psz, ::ca2::application * papp)
   {
   ...
   void file_system::replace(const char * pszContext, const char * pszFind, const char * pszReplace, ::ca2::application * papp)
   {
      stringa straTitle;
   ...
   string file_system::sys_temp(const char * pszName, const char * pszExtension, ::ca2::application * papp)
   {
   ...
   ::ca2::filesp file_system::time_square_file(::ca2::application * papp, const char * pszPrefix, const char * pszSuffix)
   {
   ...
   ::ca2::filesp file_system::get(const char * name, ::ca2::application * papp)
   {
