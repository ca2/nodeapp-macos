...
/*
 ...
 __STATIC long CLASS_DECL_mac _AfxMultMultDivDiv(
 ...
 __STATIC int32_t CLASS_DECL_mac _AfxComputeNextTab(int32_t x, UINT nTabStops, LPINT lpnTabStops, int32_t nTabOrigin, int32_t nTabWidth)
 {
 ENSURE(nTabWidth!=0);
 ...
 *(pnCurDelta + 1) = *pnCurDelta;        // double wide
 ...
 HDC CLASS_DECL_mac AfxCreateDC(HGLOBAL hDevNames, HGLOBAL hDevMode)
 {
 if (hDevNames == NULL)
 return NULL;
